...
public class Juego {
    ...
    public static Mapa mapa1 = new Mapa(50, 50, 15);
    public static Jugador jugador = new Jugador(30, 20, 15, 1, 5, 5);
    ...
    public static void main(String[] args) {
        ...
        mapa1.crearMicro();
        mapa1.crearVariosAlim(15);
        

        gui = new Interfaz(50, mapa1, textArea, textArea2);
    ...
    public static void moverMicrorganismos(){
        ...
        for (int p = 0; p < mapa1.getMaximoMicroO(); p++)
        {
            if (mapa1.orgRestantesLista() == 1)
            {
                ...
                if (cordPorMover != null && orgPorMover!=null)
                {
                    String infoOrganismo = "    Organismo movido: " + organismoMovido + "en la posicion ( " + orgPorMover[0] +", "+ orgPorMover[1]+ "\n" + "    Posición actual: (" + cordPorMover[0] + "," + cordPorMover[1] + ")";
                    gui.setSentencesInTextAreaMicro(infoOrganismo);
                }               
