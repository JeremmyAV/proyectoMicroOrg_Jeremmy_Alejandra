                ...
                if(Juego.jugador.puedeMover()){
                    ...
                    if (distancia <= Juego.jugador.getVelocidad()){
                        if("".equals(botonClicado.getText())){ //la casilla esta vacia
                            ...
                            gui.setSetencesInTextArea(textArea);
                            }
                            //revisar PORUQE NO SE ACTUALIZA LA PANTALLA
                            JTextArea textArea = Juego.getTextArea();
                            if (textArea != null) {
                                textArea.setText(""); // Borra el texto anterior
                                gui.setSetencesInTextArea(textArea);
                            }
