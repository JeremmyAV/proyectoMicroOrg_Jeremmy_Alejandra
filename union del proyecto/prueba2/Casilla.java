...
public class Casilla extends JButton implements ActionListener {
    //Jugador jugador = new Jugador (4,3,2,0);
    ...
    */
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (Juego.mapa1.getCasilla(fila, columna) != null)
        {
            if (Juego.mapa1.getCasilla(fila, columna).tipo == "alimento")
            {
                Juego.filaSiguiente = fila;
                Juego.columnaSiguiente = columna;
            }
        }
        /*
